...
object DataWithSchemaSerializer {

  def serializeV1(o: AnyRef): Array[Byte] = {
    val output = new ByteArrayOutputStream
    val avro   = AvroOutputStream.data[MovieChangedV1](output)
  ...
  def serializeV2(o: AnyRef): Array[Byte] = {
    val output = new ByteArrayOutputStream
    val avro   = AvroOutputStream.data[MovieChangedV2](output)
  ...
  def serializeV3(o: AnyRef): Array[Byte] = {
    val output = new ByteArrayOutputStream
    val avro   = AvroOutputStream.data[MovieChangedV3](output)
  ...
  def serializeV4(o: AnyRef): Array[Byte] = {
    val output = new ByteArrayOutputStream
    val avro   = AvroOutputStream.data[MovieChangedV4](output)
  ...
  def serializeV5(o: AnyRef): Array[Byte] = {
    val output = new ByteArrayOutputStream
    val avro   = AvroOutputStream.data[MovieChangedV5](output)
